...
import { lracttwo } from './lracttwo';
import { useProgress } from './ProgressContext';

function LogicalShapeMatcher() {
  ...
  useEffect(() => {
    ...
    const q = getRandomQuestion(lracttwo.easy, usedIndexes.easy) || null;
  ...
  const handleSubmit = () => {
    ...
    const nextQ = getRandomQuestion(lracttwo[nextDifficulty], nextUsed[nextDifficulty]);
    if (nextQ) {
...
export default LogicalShapeMatcher;
